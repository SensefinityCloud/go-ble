...
type WriteHandler interface {
	ServeWrite(req Request, rsp ResponseWriter, n Notifier)
}

// WriteHandlerFunc is an adapter to allow the use of ordinary functions as Handlers.
type WriteHandlerFunc func(req Request, rsp ResponseWriter, n Notifier)

// ServeWrite returns f(r, maxlen, offset).
func (f WriteHandlerFunc) ServeWrite(req Request, rsp ResponseWriter, n Notifier) {
	f(req, rsp, n)
}
